  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'radial-gradient(ellipse 80% 50% at 50% -20%, rgba(0,114,230,0.25) 0%, transparent 60%)',
      ...
      keyframes: {
        ...
        glow: { from: { boxShadow: '0 0 10px rgba(0,114,230,0.3)' }, to: { boxShadow: '0 0 25px rgba(0,114,230,0.6)' } },
      },
    },
  },
  plugins: [],
