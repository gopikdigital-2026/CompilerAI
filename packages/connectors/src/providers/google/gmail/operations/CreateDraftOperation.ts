...
export function createCreateDraftOperation(
  ...
  return {
    ...
    async execute(
      ...
      const typedInput = input as unknown as CreateDraftInput;
      ...
      const data = response.data as { id: string; message: { id: string } };
